  ...
  return (
    <div className="grid grid-cols-12 gap-16">
      <section className="col-span-8 space-y-4">
        <h3 className="font-mono text-xs font-bold tracking-wider text-neutral-300/80 uppercase">
          Sobre el proyecto
        </h3>
        <p className="text-sm leading-relaxed font-light whitespace-pre-line text-neutral-400">
          {longDescription}
        </p>
      </section>
          ...
          <ul className="space-y-4">
            {roadmap.map((item: string, index: number) => (
              <li key={index} className="group flex items-start gap-3">
                <span className="mt-0.5 shrink-0 font-mono text-xs font-bold text-neutral-600">
                  —
                </span>
