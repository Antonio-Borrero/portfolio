export default function ProfileBio() {
  return (
    <div className="flex flex-col gap-8 rounded-2xl px-6 py-5 leading-relaxed font-light">
      <p>
        Soy desarrollador{" "}
      ...
      <p>
        ...
        interfaces modernas, optimizadas y con diseños intuitivos, atractivos y
        amigables para el usuario utilizando{" "}
        <strong className="font-medium text-white">CSS (Sass)</strong>,{" "}
        <strong className="font-medium text-white">Tailwind CSS</strong> u otras
        librerías.
      </p>
